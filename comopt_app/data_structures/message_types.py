...
class FlexOrder:
    ...
    def __init__(self,id: "int", commit: "bool"):
...
class UDIevent:
    ''' The UDI-Event element describes an energy consumption or production event performed by the EMS and initiated by the Trading Agent
