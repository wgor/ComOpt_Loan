...
def start_run(run_click, active_scenarios, active_ems):
    ...
    for scenario in active_scenarios:
        ...
        env = Environment( timeperiods = global_timeperiods,
        ...
        for offer in global_offer_names :
            ...
            global_timeseries_dict[scenario]["ems"][offer] = global_timeseries_dict[scenario]["ems"][offer].groupby(level="time").reset_index()
            global_timeseries_dict[scenario]["ems"][offer] = global_timeseries_dict[scenario]["ems"][offer].shift(1)
