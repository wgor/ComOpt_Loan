...
global_environments_dict = dict()

global_output_files_dict = dict()

global_last_tab = "SC_1"
global_timeperiods = list(range(1,25))
global_test_var = 55555
global_active_sc = ""
global_sc_names = ['SC_1','SC_2','SC_3','SC_4','SC_5','SC_6','SC_7','SC_8','SC_9']
global_ems_names = ['EMS_1','EMS_2','EMS_3','EMS_4','EMS_5','EMS_6','EMS_7','EMS_8','EMS_9']
global_active_ems = []
global_ramps_dict = dict()

global_last_request_costs = 99999999999999999999
global_base_net_consumption = None
global_base_net_generation = None
global_base_net = None

global_command_line_output = ""
